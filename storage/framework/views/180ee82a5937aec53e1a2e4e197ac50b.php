            ...
            <div class="card-body">
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($user->created_at->format('F d, Y g:i A')); ?></td>
                    </tr>
                    <tr>
                        <td class="fw-bold">Last Updated:</td>
                        <td><?php echo e($user->updated_at->format('F d, Y g:i A')); ?></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-md-3 mb-3">
                        <div class="h4"><?php echo e($user->patientsCreated->count()); ?></div>
                        <small class="text-muted">Patients Created</small>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="h4"><?php echo e($user->assessments->count()); ?></div>
                        <small class="text-muted">Assessments Created</small>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="h4"><?php echo e($user->documents->count()); ?></div>
                        <small class="text-muted">Documents Uploaded</small>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="h4"><?php echo e($user->auditLogs->count()); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\document-management-system\resources\views/users/show.blade.php ENDPATH**/ ?>