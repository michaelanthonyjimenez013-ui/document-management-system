    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('reports.assessments')); ?>" class="btn btn-success">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\document-management-system\resources\views/reports/index.blade.php ENDPATH**/ ?>