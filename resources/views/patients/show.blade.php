    ...
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group btn-group-sm">
                    ...
                    <a href="{{ route('patients.assessments.create', $patient) }}" class="btn btn-outline-success">
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td>{{ $patient->birth_date->format('F d, Y') }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{ ucfirst($patient->civil_status) }}</td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td>{{ $patient->guardian_relationship ?? 'N/A' }}</td>
                            </tr>
                            <tr>
                                <td class="fw-bold">Guardian Contact:</td>
                                <td>{{ $patient->guardian_contact ?? 'N/A' }}</td>
                            </tr>
                            <tr>
        ...
        <div class="card mt-4">
            <div class="card-header">
                <i class="bi bi-clipboard-data me-2"></i>Assessments ({{ $patient->assessments->count() }})
            </div>
            <div class="card-body">
                ...
                <div class="text-center text-muted py-4">
                    ...
                    <a href="{{ route('patients.assessments.create', $patient) }}" class="btn btn-primary btn-sm">
        ...
        <div class="card mt-4">
            <div class="card-header">
                <i class="bi bi-file-earmark me-2"></i>Documents ({{ $patient->documents->count() }})
            </div>
            <div class="card-body">
                ...
                <div class="text-center text-muted py-4">
                    ...
                    <a href="{{ route('documents.create') }}?patient_id={{ $patient->id }}" class="btn btn-primary btn-sm">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('patients.assessments.create', $patient) }}" class="btn btn-primary">
                        <i class="bi bi-clipboard-plus me-2"></i>New Assessment
                    </a>
                    <a href="{{ route('documents.create') }}?patient_id={{ $patient->id }}" class="btn btn-success">
                        <i class="bi bi-upload me-2"></i>Upload Document
                    </a>
                    <a href="{{ route('export.patient', $patient) }}" class="btn btn-info">
                        <i class="bi bi-file-earmark-excel me-2"></i>Export to Excel
                    </a>
                    @if($patient->status === 'active')
                    <a href="{{ route('patients.archive', $patient) }}" class="btn btn-warning" onclick="return confirm('Archive this patient?')">
                        <i class="bi bi-archive me-2"></i>Archive Patient
                    </a>
                    @else
                    <a href="{{ route('patients.restore', $patient) }}" class="btn btn-success" onclick="return confirm('Restore this patient?')">
            ...
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-6 mb-3">
                        <div class="h4">{{ $patient->assessments->count() }}</div>
                        <small class="text-muted">Assessments</small>
                    </div>
                    <div class="col-6 mb-3">
                        <div class="h4">{{ $patient->documents->count() }}</div>
                        <small class="text-muted">Documents</small>
                    </div>
                    <div class="col-6">
                        <div class="h4">{{ $patient->assessments->where('status', 'completed')->count() }}</div>
                        <small class="text-muted">Completed</small>
                    </div>
                    <div class="col-6">
                        <div class="h4">{{ $patient->assessments->where('status', 'draft')->count() }}</div>
