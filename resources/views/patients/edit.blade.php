            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="health_record_number" name="health_record_number" value="{{ old('health_record_number', $patient->health_record_number) }}" required>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="mswd_number" name="mswd_number" value="{{ old('mswd_number', $patient->mswd_number) }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="mb-3">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="suffix" name="suffix" value="{{ old('suffix', $patient->suffix) }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="mb-3">
                        <label for="birth_date" class="form-label">Birth Date *</label>
                        <input type="date" class="form-control" id="birth_date" name="birth_date" value="{{ old('birth_date', $patient->birth_date->format('Y-m-d')) }}" required>
                        @error('birth_date')
                        <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="age" name="age" value="{{ old('age', $patient->age) }}" required>
                        @error('age')
                        <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="place_of_birth" name="place_of_birth" value="{{ old('place_of_birth', $patient->place_of_birth) }}" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nationality" name="nationality" value="{{ old('nationality', $patient->nationality) }}" required>
                        @error('nationality')
                        <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="religion" name="religion" value="{{ old('religion', $patient->religion) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="guardian_name" name="guardian_name" value="{{ old('guardian_name', $patient->guardian_name) }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="guardian_relationship" class="form-label">Relationship</label>
                        <input type="text" class="form-control" id="guardian_relationship" name="guardian_relationship" value="{{ old('guardian_relationship', $patient->guardian_relationship) }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="guardian_contact" class="form-label">Guardian Contact</label>
                        <input type="text" class="form-control" id="guardian_contact" name="guardian_contact" value="{{ old('guardian_contact', $patient->guardian_contact) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="mobile_number" name="mobile_number" value="{{ old('mobile_number', $patient->mobile_number) }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="house_number" name="house_number" value="{{ old('house_number', $patient->house_number) }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="mb-3">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="barangay" name="barangay" value="{{ old('barangay', $patient->barangay) }}" required>
                        @error('barangay')
                        <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="city_municipality" name="city_municipality" value="{{ old('city_municipality', $patient->city_municipality) }}" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="province" name="province" value="{{ old('province', $patient->province) }}" required>
                        @error('province')
                        <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
