...
<head>
    ...
    <title>@yield('title', 'Malasakit DMS') - Document Management System</title>
    ...
    <div id="sidebar" class="sidebar p-0">
        ...
        <div class="p-4 border-bottom border-secondary">
            <div class="sidebar-logo d-flex align-items-center justify-content-center">
                <img src="{{ asset('images/images__1_-removebg-preview.png') }}" alt="Malasakit DMS Logo" class="sidebar-logo-img" style="height: 60px; width: auto;">
            </div>
        </div>
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a class="nav-link {{ request()->routeIs('audit-logs.index') ? 'active' : '' }}" href="{{ route('audit-logs.index') }}">
                <i class="bi bi-clock-history"></i>
                <span class="nav-link-text">Audit Logs</span>
            </a>
            @endif
            
            <a class="nav-link {{ request()->routeIs('users.edit', auth()->user()) ? 'active' : '' }}" href="{{ route('users.edit', auth()->user()) }}">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('users.show', auth()->user()) }}"><i class="bi bi-person"></i> Profile</a></li>
                        <li><a class="dropdown-item" href="{{ route('users.edit', auth()->user()) }}"><i class="bi bi-gear"></i> Settings</a></li>
