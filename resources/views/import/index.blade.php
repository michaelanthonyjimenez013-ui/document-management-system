...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('import.patients') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('import.documents') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="import_patient_id" name="patient_id" required>
                            ...
                            <option value="{{ $patient->id }}">{{ $patient->full_name }} ({{ $patient->health_record_number }})</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
